        	...
        	@foreach($posts as $post)
	            <div class="item px-2">
	                <div class="fh5co_hover_news_img">
	                    ...
	                    <div>
	                        <a href="single.html" class="d-block fh5co_small_post_heading"><span class="">
	                        	{{ $post->title }}
	                        </span></a>
                ...
                @foreach($posts as $post)
	                <div class="row pb-4">
	                    ...
	                    <div class="col-md-7 animate-box">
	                        	<br>
	                        <a href="{{ route('post.show', $post->slug) }}" class="fh5co_magna py-2"> {{ $post->title }} </a> <a href="single.html" class="fh5co_mini_time py-3">
	                        @if ($post->user)
	                        	{{ $post->user->name }}
	                        	-
	                        @endif
	                        {{ $post->created_at->format('H:i d/m/Y') }} </a>
